...
5. React redux might not immediately work in a recently deployed website, casuing restaurants in restaurants page to never load. Fix is to just wait a few minutes and refresh the page
